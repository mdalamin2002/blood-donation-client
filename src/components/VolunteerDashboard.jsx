...
export default function VolunteerDashboard() {
  ...
  useEffect(() => {
    ...
    fetch("https://mission-scic11-server-template.vercel.app/api/users")
      .then(res => res.json())
      .then(data => {
    ...
    fetch("https://mission-scic11-server-template.vercel.app/api/funds")
      .then(res => res.json())
      .then(data => {
    ...
    fetch("https://mission-scic11-server-template.vercel.app/api/donation-requests")
      .then(res => res.json())
      .then(data => {
