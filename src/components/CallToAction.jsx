...
const CallToAction = () => {
  return (
    <section className="relative bg-gradient-to-tr from-red-50 to-red-100 py-14 sm:py-16 md:py-20 px-4 sm:px-6 md:px-20 rounded-3xl mx-3 sm:mx-6 md:mx-24 my-8 sm:my-10 md:my-12 shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="mt-6 sm:mt-8 md:mt-10 flex justify-center flex-wrap gap-3 sm:gap-4 md:gap-5">
          ...
          <Link
            to="/registration"
            className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold text-sm sm:text-base transition-all duration-300 shadow-md hover:shadow-lg"
          >
          ...
          {/* Secondary Button */}
          <Link
            to="/AllDonationRequests"
            className="bg-white cursor-pointer text-red-500 border border-red-200 hover:bg-red-50 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold text-sm sm:text-base transition-all duration-300 shadow-md hover:shadow-lg"
          >
            View Blood Requests
          </Link>
        </div>
